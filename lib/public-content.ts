...
const FALLBACK_COLLECTIONS: PublicCollection[] = [
  {
    ...
    images: ["/images/princess-irulan/01.jpg", "/images/princess-irulan/02.jpg", "/images/princess-irulan/03.jpg", "/images/princess-irulan/04.jpg", "/images/princess-irulan/05.jpg", "/images/princess-irulan/06.jpg", "/images/princess-irulan/07.jpg"],
  ...
  },
  {
    ...
    images: ["/images/fallen-garden/01.jpg", "/images/fallen-garden/02.jpg", "/images/fallen-garden/03.jpg", "/images/fallen-garden/04.jpg", "/images/fallen-garden/05.jpg", "/images/fallen-garden/06.jpg", "/images/fallen-garden/07.jpg", "/images/fallen-garden/08.jpg", "/images/fallen-garden/09.jpg", "/images/fallen-garden/10.jpg"],
  ...
  },
  {
    ...
    images: ["/images/tarchi-vests/01.jpg", "/images/tarchi-vests/02.jpg", "/images/tarchi-vests/03.jpg", "/images/tarchi-vests/04.jpg", "/images/tarchi-vests/05.jpg", "/images/tarchi-vests/06.jpg", "/images/tarchi-vests/07.jpg"],
  ...
  },
  {
    ...
    images: ["/images/graphiti-tshirts/01.jpg", "/images/graphiti-tshirts/02.jpg", "/images/graphiti-tshirts/03.jpg", "/images/graphiti-tshirts/04.jpg", "/images/graphiti-tshirts/05.jpg", "/images/graphiti-tshirts/06.jpg", "/images/graphiti-tshirts/07.jpg"],
  ...
  },
  {
    ...
    images: ["/images/tarchi-summer/01.jpg", "/images/tarchi-summer/02.jpg", "/images/tarchi-summer/03.jpg", "/images/tarchi-summer/04.jpg", "/images/tarchi-summer/05.jpg", "/images/tarchi-summer/06.jpg", "/images/tarchi-summer/07.jpg", "/images/tarchi-summer/08.jpg", "/images/tarchi-summer/09.jpg", "/images/tarchi-summer/10.jpg", "/images/tarchi-summer/11.jpg"],
  ...
  },
  {
    ...
    images: ["/images/love-in-air/01.jpg", "/images/love-in-air/02.jpg", "/images/love-in-air/03.jpg", "/images/love-in-air/04.jpg", "/images/love-in-air/05.jpg", "/images/love-in-air/06.jpg", "/images/love-in-air/07.jpg", "/images/love-in-air/08.jpg"],
  ...
  },
  {
    ...
    images: ["/images/mens-shirt/01.jpg", "/images/mens-shirt/02.jpg", "/images/mens-shirt/03.jpg", "/images/mens-shirt/04.jpg", "/images/mens-shirt/05.jpg"],
...
const FALLBACK_RESEARCH: PublicResearch[] = [
  {
...
function asTag(collection: Pick<PublicCollection, "season" | "year">) {
...
function normalizeCollection(doc: any): PublicCollection {
  return {
    slug: doc.slug,
    title: doc.title,
    season: doc.season,
...
function normalizeResearch(doc: any): PublicResearch {
  return {
    slug: doc.slug,
    title: doc.title,
...
export async function getPublishedCollections(): Promise<PublicCollection[]> {
  try {
    ...
    if (!docs.length) return fallbackCollections();
...
export async function getPublishedCollectionBySlug(slug: string): Promise<PublicCollection | null> {
  try {
    ...
    if (doc) return normalizeCollection(doc);
  } catch {
    // fallback below
  }

  return fallbackCollections().find(item => item.slug === slug) || null;
}
...
export async function getPublishedResearch(): Promise<PublicResearch[]> {
  try {
    ...
    if (!docs.length) return fallbackResearch();
    return docs.map(normalizeResearch);
  } catch {
...
export async function getPublishedResearchBySlug(slug: string): Promise<PublicResearch | null> {
  try {
    ...
    if (doc) return normalizeResearch(doc);
  } catch {
    // fallback below
  }

  return fallbackResearch().find(item => item.slug === slug) || null;
}
